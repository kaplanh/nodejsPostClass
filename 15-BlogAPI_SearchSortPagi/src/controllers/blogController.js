...
module.exports.BlogPost = {
    list: async (req, res) => {
        // biz bu islemleri buraya yazdigimiz icin sdc  BlogPost da yapiyoruz  BlogCategory ve user dada yapmak istedigimizden her defasinda yeniden yazmamak icin bir middleware olarak yazip istedigimiz her yerde cagirip kullanmak icin buraya degil middlewares/findSearchSortPage.js de yaziyorum ve index.js de require() yapip calistiriyoruz
        ...
        not:.env dosyasindan veri ne yazarsak yazalim string gelir 
